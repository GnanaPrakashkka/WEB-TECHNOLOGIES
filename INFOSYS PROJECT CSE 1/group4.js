...
function bhargavi(){
    var s=fileValidation();
    alert("wvydweuy");
    if(s){
        document.getElementById("b1").setAttribute("href","signatureform.html");
        document.getElementById("b2").setAttribute("href","signatureform.html");
    }
    else{
        alert("ammave")
         document.getElementById("b1").setAttribute("href","#");
        document.getElementById("b2").setAttribute("href","#");
    }
}